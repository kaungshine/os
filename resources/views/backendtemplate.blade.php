      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('brands.create')}}">Brand</a>
            <a class="collapse-item" href="{{route('categories.create')}}">Category</a>
            <a class="collapse-item" href="{{route('subcategories.create')}}">Subcategory</a>
            <a class="collapse-item" href="{{route('items.create')}}">Item</a>
          </div>
        </div>
      </li>
